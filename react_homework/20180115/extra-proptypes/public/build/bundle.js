...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Article = (function (_React$Component) {
	    ...
	    _createClass(Article, [{
	        ...
	        value: function render() {
	            ...
	            var pictureURL = _props.pictureURL;
	            var author = _props.author;
	            var type = _props.type;
	            var tags = _props.tags;
	            var numberOfLikes = _props.numberOfLikes;
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement('img', { src: pictureURL, width: '100%' }),
	                _react2['default'].createElement(
	                    'p',
	...
	Article.propTypes = {
	    ...
	    pictureURL: _propTypes2['default'].string,
	    author: _propTypes2['default'].shape({
	        name: _propTypes2['default'].string,
	        avatarURL: _propTypes2['default'].string,
	        numberOfArticles: _propTypes2['default'].number
	    }),
	    type: _propTypes2['default'].oneOf(['education', 'entertainment']),
	    tags: _propTypes2['default'].arrayOf(_propTypes2['default'].string),
	    numberOfLikes: _propTypes2['default'].number
	};
